...
public class DataSeeder implements CommandLineRunner {
    ...
    private List<Driver> seedDrivers() {
        return driverRepository.saveAll(List.of(
                Driver.builder().name("Ram saha").licenseNumber("WB-2024-001")
                        .phone("+91 7894561230").email("ram@tms.com").status(DriverStatus.ACTIVE).build(),
                Driver.builder().name("Krishna saha").licenseNumber("WB-2024-002")
                        .phone("+91 9876543210").email("krishna@tms.com").status(DriverStatus.ACTIVE).build(),
                Driver.builder().name("Sita saha").licenseNumber("WB-2024-003")
                        .phone("+91 6549873210").email("sita@tms.com").status(DriverStatus.ACTIVE).build(),
                Driver.builder().name("Shiv saha").licenseNumber("WB-2024-004")
                        .phone("+91 8527419630").email("shiv@tms.com").status(DriverStatus.ACTIVE).build(),
                Driver.builder().name("bishnu").licenseNumber("KA-2024-005")
                        .phone("+91 4569870123").email("bishnu@tms.com").status(DriverStatus.ACTIVE).build()
    ...
    private List<Route> seedRoutes() {
        return routeRepository.saveAll(List.of(
                Route.builder().origin("KOLKATA").destination("HYDRABAD")
                        .distance(1200.0).estimatedTimeMinutes(560)
                        .description("KOL to HYDRABAD via I-95 N").build(),
                Route.builder().origin("HYDRABAD").destination("KOLKATA")
                        .distance(1512.0).estimatedTimeMinutes(250)
                        .description("HYDRABAD to KOL via NJ Turnpike").build(),
                Route.builder().origin("PUNE").destination("KOLKATA")
                        .distance(365.0).estimatedTimeMinutes(270)
                        .description("PUNE to KOLKATA via I-95 S").build(),
                Route.builder().origin("KOLKATA").destination("PUNE")
                        .distance(382.0).estimatedTimeMinutes(280)
                        .description("KOLKATA to PUNE via I-94 E").build(),
                Route.builder().origin("BANGALURU").destination("KOLKATA")
                        .distance(265.0).estimatedTimeMinutes(200)
                        .description("BANGALURU to KOLKATA via I-65 S").build()
    ...
    private List<LorryReceipt> seedLorryReceipts() {
        return lrRepository.saveAll(List.of(
                ...
                LorryReceipt.builder().lrNumber("LR-2026-0001").consignor("ABC Industries").consignee("XYZ Traders")
                        .origin("KOLKATA").destination("PUNE").material("Steel Pipes")
                ...
                LorryReceipt.builder().lrNumber("LR-2026-0002").consignor("Global Corp").consignee("Local Mart")
                        .origin("KOLKATA").destination("HYDRABAD").material("Electronics")
                ...
                LorryReceipt.builder().lrNumber("LR-2026-0003").consignor("Metro Chemicals").consignee("Green Pharma")
                        .origin("KOLKATA").destination("BANGALURU").material("Pharmaceutical Raw Materials")
                ...
                LorryReceipt.builder().lrNumber("LR-2026-0004").consignor("Fresh Farms Co").consignee("City Grocers")
                        .origin("KOLKATA").destination("DELHI").material("Frozen Foods")
                ...
                LorryReceipt.builder().lrNumber("LR-2026-0005").consignor("Textile Hub").consignee("Fashion Retail Ltd")
                        .origin("KOLKATA").destination("NOIDA").material("Cotton Fabric Rolls")
                ...
                LorryReceipt.builder().lrNumber("LR-2026-0006").consignor("AutoParts Inc").consignee("QuickFix Garage")
                        .origin("KOLKATA").destination("PUNE").material("Auto Spare Parts")
                ...
                LorryReceipt.builder().lrNumber("LR-2026-0007").consignor("BuildRight Materials").consignee("SkyHigh Constructions")
                        .origin("KOLKATA").destination("HYDRABAD").material("Cement Bags")
                ...
                LorryReceipt.builder().lrNumber("LR-2026-0008").consignor("DataTech Solutions").consignee("CloudNet Inc")
                        .origin("KOLKATA").destination("BANGALURU").material("Server Equipment")
                ...
                LorryReceipt.builder().lrNumber("LR-2026-0009").consignor("Fresh Farms Co").consignee("Healthy Bites")
                        .origin("KOLKATA").destination("DELHI").material("Organic Vegetables")
                ...
                LorryReceipt.builder().lrNumber("LR-2026-0010").consignor("Pacific Imports").consignee("East Coast Retail")
                        .origin("KOLKATA").destination("HYDRABAD").material("Furniture")
                ...
                LorryReceipt.builder().lrNumber("LR-2026-0011").consignor("ABC Industries").consignee("MegaBuild Corp")
                        .origin("KOLKATA").destination("PUNE").material("Structural Steel")
                ...
                LorryReceipt.builder().lrNumber("LR-2026-0012").consignor("Global Corp").consignee("TechZone Retail")
                        .origin("KOLKATA").destination("BANGALURU").material("Laptops & Monitors")
    ...
    private void seedBookings(List<Trip> trips) {
        ...
        bookingRepository.saveAll(List.of(
                Booking.builder().customerName("client1").customerPhone("+91 7894561230")
                        .customerEmail("client1@example.com").trip(busTripNYBoston).seatCount(2)
                        .status(BookingStatus.CONFIRMED).notes("Window seats preferred").build(),
                Booking.builder().customerName("client2").customerPhone("+91 1234567890")
                        .customerEmail("client2@example.com").trip(busTripNYBoston).seatCount(4)
                        .status(BookingStatus.CONFIRMED).notes("Family trip — 2 adults, 2 children").build(),
                Booking.builder().customerName("client3").customerPhone("+91 4569871230")
                        .customerEmail("client4@example.com").trip(busTripNYBoston).seatCount(1)
                        .status(BookingStatus.CONFIRMED).notes("Business travel").build(),
                Booking.builder().customerName("client4").customerPhone("+91 8523697410")
                        .customerEmail("client4@example.com").trip(busTripNYBoston).seatCount(3)
                        .status(BookingStatus.CANCELLED).notes("Plans changed — cancelled by customer").build(),
                Booking.builder().customerName("client5").customerPhone("+91 7410258963")
                        .customerEmail("client5@example.com").trip(busTripNYBoston).seatCount(2)
